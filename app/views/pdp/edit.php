                    ...
                    <form action="function_edit.php" method="post">
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 ">
                                <input class="form-control" type="text" name="nama" value="<?= $npositif['nama'] ?>"
                                    required="">
                                <input class="form-control" type="hidden" name="id" value="<?= $npositif['id'] ?>"
                                    required="">
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 ">
                                <input name="alamat" class="form-control" value="<?= $npositif['alamat'] ?>" type="text"
                                    required="">
                            </div>
                        </div>
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6">
                                <input name="keterangan" class="form-control" value="<?= $npositif['keterangan'] ?>"
                                    type="text" required="">
                            </div>
                        </div>
                        <div class="item form-group">
